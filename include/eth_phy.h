...
static inline eth_phy_type_t rmiiPhyType(int idx) {
    switch (idx) {
        case 0:  return ETH_PHY_LAN8720;
        case 1:  return ETH_PHY_TLK110;      // IP101 is pin-compatible, TLK110 driver works
        case 2:  return ETH_PHY_RTL8201;
        case 3:  return ETH_PHY_DP83848;
        case 4:  return ETH_PHY_KSZ8081;
        case 5:  return ETH_PHY_JL1101;     // falls through to GENERIC on some SDKs
