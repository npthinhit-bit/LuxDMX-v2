...
- [x] Testing infrastructure (native: 19 ctest executables green; fixture contract, lifecycle report, ArtDMX fixture and Art-Net dispatcher integration tests added; all CTest cases labeled `native` with a 10-second timeout; host OTA signing contract test)
