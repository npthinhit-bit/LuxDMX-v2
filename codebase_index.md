...
- [x] Testing infrastructure (native: 16 ctest executables green; fixture contract test added; all CTest cases labeled `native` with a 10-second timeout; host OTA signing contract test)
